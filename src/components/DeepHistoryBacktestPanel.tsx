      ...
      <div className="flex items-start justify-between mb-3 flex-wrap gap-2">
        <div>
          <h3 className="font-display font-semibold text-sm">
            Deep-History Backtest <span className="text-muted-foreground">· daily bars</span>
          </h3>
          <p className="text-[10px] text-muted-foreground">
            Walk-forward over {bars > 0 ? `${bars} multi-year daily bars` : "fetched deep history"}{" "}
            · same hybrid engine, no look-ahead.
          </p>
        </div>
